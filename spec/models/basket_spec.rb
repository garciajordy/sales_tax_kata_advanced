...
RSpec.describe Basket, type: :model do
  ...
  describe '#output' do
    it 'returns the correct output' do
      ...
      output = ['1 imported bottle of perfume: 32.19', '1 bottle of perfume: 20.89', '1 packet of headache pills: 9.75', '1 box of imported chocolates: 11.85', 'Sales tax: 6.70', 'Total: 74.68']
  ...
  describe '#total' do
    it 'returns the total of all line_items' do
      user = User.create(email: 'test@example.com', password: '123456')
      basket = described_class.create(name: 'test_basket', user_id: user.id)
      LineItem.create(quantity: 1, name: 'imported box of chocolate', price: 10.00, basket_id: basket.id)
      LineItem.create(quantity: 1, name: 'imported bottle of perfume', price: 47.50, basket_id: basket.id)

      expect(basket.total).to eq(65.15)
    end
  end
end
